...
//************************************** */
//************************************** */
//MUST BE REFACTORED TO USE THE PERSONAL PROPERTY MASTER ENDPOINT
//************************************** */
//************************************** */


class MasterPersPropModel {
  ...
  //   const url = `${API_ENDPOINTS.MasterPersPropModel}?${new URLSearchParams(query).toString()}`;
...
module.exports = MasterPersPropModel;