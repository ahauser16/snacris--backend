...
- [ ] Keep the `userAuth.json`, `userNew.json`, `userRegister.json` and `userUpdate.json` files as they are and create a schema for each ACRIS dataset to be used to validate the API calls in the associated routes.
