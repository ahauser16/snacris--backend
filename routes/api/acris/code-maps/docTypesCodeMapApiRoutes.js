 ...
 *
 * Technical Explanation: This route fetches data from the ACRIS-Document Type Codes API based on the query parameters provided. It constructs the URL using URLSearchParams and makes a GET request to the API. It returns the fetched records. This route was used exclusively during development for Postman-based API exploration and testing.
 *
