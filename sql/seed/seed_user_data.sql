-- 1. Saved Properties for testadmin
INSERT INTO saved_properties (username, borough, block, lot)
VALUES
  ('testadmin', 1, 62, 1),
  ('testadmin', 1, 835, 41),
  ('testadmin', 1, 1134, 1);

-- 2. Saved Party Contacts for testadmin
INSERT INTO saved_party_contacts (username, name, address_1, address_2, city, state, country, zip)
VALUES
  ('testadmin', 'AMERICAN INTERNATIONAL GROUP, INC.', '70 PINE STREET', '', 'New York', 'NY', 'US', '10270'),
  ('testadmin', 'NEW YORK CITY ECONOMIC DEVELOPMENT CORPORATION', 'ONE LIBERTY PLAZA', '', 'New York', 'NY', 'US', '10006'),
  ('testadmin', 'NEW YORK CITY ECONOMIC DEVELOPMENT CORPORATION', '110 WILLIAM STREET', '', 'New York', 'NY', 'US', '10038');

-- 3. Saved Party Names for testadmin
INSERT INTO saved_party_names (username, name)
VALUES
  ('testadmin', 'AMERICAN INTERNATIONAL GROUP, INC.'),
  ('testadmin', 'AMERICAN INTERNATIONAL GROUP'),
  ('testadmin', 'NEW YORK CITY ECONOMIC DEVELOPMENT CORPORATION'),
  ('testadmin', 'NEW YORK CITY LAND DEVELOPMENT CORPORATION'),
  ('testadmin', 'THE CITY OF NEW YORK');

-- 4. Saved Real Property Record #1 for testadmin
...
-- 5. Saved Real Property Legals for master_id 1
...
-- 6. Saved Real Property Parties for master_id 1
...
-- 7. Saved Real Property Remarks for master_id 1
...
-- 8. Saved Personal Property Record #1 for testadmin
...
INSERT INTO note_properties (note_id, borough, block, lot)
VALUES
  (1, 1, 62, 1),      -- NYCEDC HQ
  (2, 1, 835, 41),    -- Empire State Building
  (3, 1, 1134, 1);    -- Lincoln Center For The Performing Arts

-- 14. Associate notes with saved_party_contacts
INSERT INTO note_party_contacts (note_id, name, address_1, address_2, city, state, zip, country)
VALUES
  (4, 'AMERICAN INTERNATIONAL GROUP, INC.', '70 PINE STREET', '', 'New York', 'NY', '10270', 'US'), -- My first job
  (5, 'NEW YORK CITY ECONOMIC DEVELOPMENT CORPORATION', 'ONE LIBERTY PLAZA', '', 'New York', 'NY', '10006', 'US'), -- Current Address
  (6, 'NEW YORK CITY ECONOMIC DEVELOPMENT CORPORATION', '110 WILLIAM STREET', '', 'New York', 'NY', '10038', 'US'); -- Prior Address

-- 15. Associate notes with saved_party_names
INSERT INTO note_party_names (note_id, name)
VALUES
  (7, 'NEW YORK CITY LAND DEVELOPMENT CORPORATION'), -- Conduit Fee Title Issuer
  (8, 'THE CITY OF NEW YORK');                      -- Original Fee Title Holder
