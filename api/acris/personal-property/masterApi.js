...
class PersonalPropertyMasterApi {
    ...
    static async fetchFromAcris(query) {
        const url = `${API_ENDPOINTS.personalPropertyMaster}?${new URLSearchParams(query).toString()}`;
...
module.exports = PersonalPropertyMasterApi;