...
class PersonalPropertLegalsApi {
    ...
    static async fetchFromAcris(query) {
        const url = `${API_ENDPOINTS.personalPropertyLegals}?${new URLSearchParams(query).toString()}`;
...
module.exports = PersonalPropertLegalsApi;